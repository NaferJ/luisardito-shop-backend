...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addIndex('leaderboard_snapshots', ['usuario_id', 'snapshot_date'], {
    ...
    await queryInterface.addIndex('leaderboard_snapshots', ['position', 'snapshot_date'], {
