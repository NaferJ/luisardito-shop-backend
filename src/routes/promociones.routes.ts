...
import promocionesCtrl from "../controllers/promociones.controller";
...
router.put(
  ...
  authRequired,
  permiso("gestionar_productos"),
  promocionesCtrl.actualizarEstados
);
...
router.get(
  ...
  authRequired,
  permiso("gestionar_productos"),
  promocionesCtrl.obtenerPromocionesProducto
);
...
router.delete(
  ...
  authRequired,
  permiso("gestionar_productos"),
  promocionesCtrl.eliminarPermanente
);
...
router.get(
  ...
  authRequired,
  permiso("gestionar_productos"),
  promocionesCtrl.obtenerEstadisticas
);
 ...
 */
router.post(
  "/:promocionId/productos",
  authRequired,
  permiso("gestionar_productos"),
  promocionesCtrl.asignarProductos
);
 ...
 */
router.delete(
  "/:promocionId/productos/:productoId",
  authRequired,
  permiso("gestionar_productos"),
  promocionesCtrl.desasignarProducto
);
