...
async function main() {
    ...
    try {
        ...
        console.log('⚠️  Asegúrate de haber creado un backup reciente si es necesario\n');

        const confirm = await promptUser('¿Estás seguro de continuar? (escribe "SI" para confirmar): ');
