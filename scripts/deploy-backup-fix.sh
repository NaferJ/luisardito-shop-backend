...
echo "1️⃣ Haciendo pull de los cambios..."
git pull
echo ""

echo "2️⃣ Reconstruyendo la imagen..."
docker compose -f docker-compose.yml -f docker-compose.prod.yml build api
echo ""

echo "3️⃣ Reiniciando el contenedor..."
docker compose -f docker-compose.yml -f docker-compose.prod.yml up -d api
echo ""

echo "4️⃣ Esperando a que el contenedor esté listo..."
sleep 10
echo ""

echo "5️⃣ Verificando logs de inicio:"
docker logs luisardito-backend 2>&1 | grep -i "scheduler\|backup" | tail -10
echo ""

echo "6️⃣ Probando un backup manual..."
...
echo "7️⃣ Verificando el archivo creado:"
